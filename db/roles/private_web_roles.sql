...
GRANT SELECT ON control_identities, control_role_grants, workspaces, control_web_sessions,
  ...
  control_abs_story_versions, control_abs_source_observations, control_abs_source_settings, control_abs_story_archives, control_idea_sessions, control_idea_contributions,
  control_idea_syntheses, control_idea_decisions, control_idea_bot_run_events TO control_room_private_web;
...
GRANT INSERT ON control_web_sessions, adapter_registry, projects, control_manual_project_heads,
  ...
  control_completion_gate_records, control_web_task_review_commands, control_abs_source_settings, control_abs_story_archives TO control_room_private_web;
