...
GRANT SELECT ON control_identities, control_role_grants, workspaces, control_web_sessions,
  ...
  control_abs_story_versions, control_abs_source_observations, control_abs_source_settings, control_idea_sessions, control_idea_contributions,
...
GRANT INSERT ON control_web_sessions, adapter_registry, projects, control_manual_project_heads,
  ...
  control_completion_gate_records, control_web_task_review_commands, control_abs_source_settings TO control_room_private_web;
