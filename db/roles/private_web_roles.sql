...
GRANT SELECT ON control_identities, control_role_grants, workspaces, control_web_sessions,
  ...
  control_idea_syntheses, control_idea_decisions, control_idea_bot_run_events, control_policy_decisions TO control_room_private_web;
...
GRANT INSERT ON control_web_sessions, adapter_registry, projects, control_manual_project_heads,
  ...
  control_policy_decisions, control_project_lifecycle_events TO control_room_private_web;
