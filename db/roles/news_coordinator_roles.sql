...
GRANT SELECT ON tenants, workspaces, projects, control_manual_project_heads, control_identities,
  ...
  control_policy_decisions, control_news_feed_plans, control_news_source_settings, audit_events, control_audit_chain_heads TO control_room_news_coordinator;
GRANT INSERT ON control_web_sessions, control_requests, control_workflows, control_jobs, control_attempts,
  ...
  control_approval_consumptions, control_policy_decisions, control_news_feed_plans, audit_events,
