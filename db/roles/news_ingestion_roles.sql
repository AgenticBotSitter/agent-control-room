...
GRANT SELECT ON workspaces, projects, control_identities, control_role_grants,
  control_news_story_versions, control_news_source_observations, control_news_discovery_baselines, control_news_source_settings, control_news_story_archives, control_news_article_details TO control_room_news_ingestion;
GRANT INSERT ON control_news_story_versions, control_news_source_observations, control_news_discovery_baselines, control_news_article_details TO control_room_news_ingestion;
