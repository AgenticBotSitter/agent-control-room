...
GRANT SELECT ON workspaces, projects, control_identities, control_role_grants,
  control_abs_story_versions, control_abs_source_observations TO control_room_news_ingestion;
GRANT INSERT ON control_abs_story_versions, control_abs_source_observations TO control_room_news_ingestion;
