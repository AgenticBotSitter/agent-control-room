...
CREATE TABLE control_news_feed_plans (
...
CREATE TRIGGER control_news_feed_plan_immutable BEFORE UPDATE OR DELETE ON control_news_feed_plans
  FOR EACH ROW EXECUTE FUNCTION reject_append_only_mutation();
CREATE TRIGGER control_news_feed_plan_no_truncate BEFORE TRUNCATE ON control_news_feed_plans
