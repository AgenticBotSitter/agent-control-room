...
CREATE TABLE control_news_article_details (
...
CREATE TRIGGER control_news_article_details_immutable BEFORE UPDATE OR DELETE ON control_news_article_details
  FOR EACH ROW EXECUTE FUNCTION reject_append_only_mutation();
CREATE TRIGGER control_news_article_details_no_truncate BEFORE TRUNCATE ON control_news_article_details
