...
| DR-08 Initial workspaces | Native Git detached checkout behind ownership/lease checks | Concrete port, durable intent/creation/removal journal and read-only observation; native preservation and forced-process journal tests | Interrupted native Git recovery, safe re-adoption, durable root binding, retention and runtime integration remain open |
