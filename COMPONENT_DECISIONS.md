...
| DR-13 Work engine | Conditionally retain pg-boss 12.30.0 and existing CR adapters | Both pg-boss and DBOS pass the short review-phase comparison; no required replacement benefit demonstrated. Existing submission/worker/runtime suite restored to contributor checkout: 50 synthetic tests pass | Integrated canonical admission/replay, uncertain native start, process crash, real drain, occurrence and PG17-role gates; synthetic port tests do not close live recovery acceptance |
