...
| DR-09 Calendar calculation | cron-parser 5.10.0 field expansion/matching; retain schedule policy | 42 frozen baseline parity cases now pass against integrated code; native occurrence-store concurrency/replay checks pass | Independent integration review and dispatch/recovery acceptance; run frozen regressions on upgrades; not queue selection |
