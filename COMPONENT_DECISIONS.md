...
| DR-09 Calendar calculation | cron-parser 5.10.0 field expansion/matching; retain schedule policy | 42 research parity cases; typed calculator and native occurrence-store concurrency/replay checks now implemented locally | Full parity/upgrade regressions, independent integration review and dispatch/recovery acceptance; not queue selection |
