...
| CR-6Q fleet/scheduler architecture review | Codex review and remediation complete; independent review pending | Mixed-node isolation, stale/future evidence, live-status drift, reservation time, and default-suite gaps fixed; `CR6Q_ACCEPTANCE.md` |
...
```text
Active: CR-6Q independent review of the remediated fleet/scheduler head is ready for direct bot claim in jobber #155; CR-6E owner acceptance remains a separate owner gate
