...
```text
Active: CR-6E owner acceptance and remaining protected detail reads
...
Owner input required now: owner review of the protected dashboard according to `CR6E_ACCEPTANCE.md`; exact approval remains required before installing or starting a native service, a new macOS native attempt, credentials, live artifact namespaces, deployment, live integration, or consequential effects
...
```text
Block: CR-6E — owner acceptance and remaining protected detail reads
...
Expected output: owner acceptance of the protected dashboard and, if accepted, individually scoped protected project/worker detail reads. The completed dashboard already supplies redacted fleet, portfolio, service/schedule/incident, bottleneck, Action Inbox, and Owner Focus views.
