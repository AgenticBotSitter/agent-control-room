...
Apply reviewed migrations 0001–0042 as a separate restricted LOGIN that directly owns the public tables.
...
2. Requires the current reviewed schema digest and exactly 129 validated public table names. It locks all
