...
Apply unchanged migrations 0001–0040 as a separate restricted LOGIN that directly owns the public tables.
...
2. Requires the unchanged reviewed schema digest and exactly 127 validated public table names. It locks all
