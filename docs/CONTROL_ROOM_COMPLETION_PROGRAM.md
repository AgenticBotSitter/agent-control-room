...
| CR11B-AUTO-030 | Codex | Protected automatic ready promotion and scheduler/jobber handoff under exact standing policy | SECOND REMEDIATION — initial candidate and first remediation rejected; another different-agent re-review required |
