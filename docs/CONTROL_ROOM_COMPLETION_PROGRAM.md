...
| CR11B-AUTO-030 | Codex | Protected automatic ready promotion and scheduler/jobber handoff under exact standing policy | THIRD REMEDIATION — initial candidate plus first and second remediations rejected; another different-agent re-review required |
