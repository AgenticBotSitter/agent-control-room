...
import { NEWS_ACTION_IDS_V1, NEWS_CONTRACT_V1 } from "./types";
...
export const newsCanonicalUrlSchemaV1 = z.string().min(12).max(2_000).refine(isCanonicalPublicHttpsUrl, "URL must be canonical public HTTPS without credentials, port, query, or fragment");
...
export const newsDiscoveryEndpointSchemaV1 = z.string().min(12).max(2_000).refine(value => {
  try {
    const url = new URL(value);
    if (url.href !== value) return false;
    url.search = "";
...
export const newsSourceEvidenceSchemaV1 = z.object({
  ...
  canonicalUrl: newsCanonicalUrlSchemaV1,
...
export const newsStorySchemaV1 = z.object({
  contractVersion: z.literal(NEWS_CONTRACT_V1),
  ...
  sourceEvidence: z.array(newsSourceEvidenceSchemaV1).min(1).max(32),
...
export const newsStoryInputSchemaV1 = newsStorySchemaV1.omit({
...
export const newsActionTemplateSchemaV1 = z.object({
  actionId: z.enum(NEWS_ACTION_IDS_V1),
...
export const newsWorkOrderProposalSchemaV1 = z.object({
  ...
  sourceUrls: z.array(newsCanonicalUrlSchemaV1).min(1).max(32),
...
export const newsProposalInputSchemaV1 = z.object({
  proposalId: projectWorkspaceSafeIdSchemaV1,
  tenantId: projectWorkspaceSafeIdSchemaV1,
  workspaceId: projectWorkspaceSafeIdSchemaV1,
  projectId: projectWorkspaceSafeIdSchemaV1,
...
export const newsProposalReviewSchemaV1 = z.object({
  contractVersion: z.literal(NEWS_CONTRACT_V1),
...
export const newsProposalReviewInputSchemaV1 = z.object({
  reviewId: projectWorkspaceSafeIdSchemaV1,
  proposal: z.unknown(),
  decision: z.enum(["accepted", "rejected"]),
  safeReasonCode: projectWorkspaceSafeIdSchemaV1,
...
export const newsMaterializationReceiptSchemaV1 = z.object({
  contractVersion: z.literal(NEWS_CONTRACT_V1),
...
export const newsMaterializationInputSchemaV1 = z.object({
  proposal: z.unknown(),
...
export const newsAutomationDeclarationSchemaV1 = z.object({
  contractVersion: z.literal(NEWS_CONTRACT_V1),
...
export const newsAutomationDeclarationInputSchemaV1 = z.object({
  automationId: projectWorkspaceSafeIdSchemaV1,
  tenantId: projectWorkspaceSafeIdSchemaV1,
  workspaceId: projectWorkspaceSafeIdSchemaV1,
  projectId: projectWorkspaceSafeIdSchemaV1,
...
export const newsAutomationRunSchemaV1 = z.object({
  contractVersion: z.literal(NEWS_CONTRACT_V1),
...
const newsDiscoveredUrlSchemaV1 = z.string().min(12).max(2_000).refine((value) => {
  try {
    const url = new URL(value);
...
export const newsCollectedItemSchemaV1 = z.object({
  ...
  title: z.string().min(1).max(240),
  summary: projectWorkspaceSummarySchemaV1,
  discoveredUrl: newsDiscoveredUrlSchemaV1,
  publishedAt: projectWorkspaceTimeSchemaV1.optional(),
  observedAt: projectWorkspaceTimeSchemaV1,
...
export const newsFakeCollectionBatchSchemaV1 = z.object({
  batchId: projectWorkspaceSafeIdSchemaV1,
  sourceId: projectWorkspaceSafeIdSchemaV1,
  sourceKind: z.enum(["rss", "sitemap", "newsletter"]),
  sourceLabel: projectWorkspaceLabelSchemaV1,
  collectedAt: projectWorkspaceTimeSchemaV1,
  items: z.array(newsCollectedItemSchemaV1).max(1_000),
...
export const newsCollectionInputSchemaV1 = z.object({
  tenantId: projectWorkspaceSafeIdSchemaV1,
  workspaceId: projectWorkspaceSafeIdSchemaV1,
  projectId: projectWorkspaceSafeIdSchemaV1,
  batches: z.array(newsFakeCollectionBatchSchemaV1).max(100),
  collectedAt: projectWorkspaceTimeSchemaV1,
}).strict();

export const newsQueueHistorySchemaV1 = z.object({
