...
export const taskAttentionReasons = ["proposal", "approval", "failed", "orphaned", "review",
...
export const taskAttentionPageSchema = z.object({
  items: z.array(z.object({ task: taskSummarySchema, reasons: z.array(z.enum(taskAttentionReasons)).min(1).max(9) }).strict()).max(25),
