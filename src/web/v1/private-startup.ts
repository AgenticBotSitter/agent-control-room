...
export type PrivateStartupConfiguration = Omit<PrivateWebProcessOptions, "database" | "clock" | "drainMs" | "planning" | "assignment" | "revisions" | "ideaCreation"> & {
...
export function validatePrivateStartupConfiguration(input: PrivateStartupConfiguration) {
  ...
  try {
    ...
    if ("planning" in input || "assignment" in input || "revisions" in input || "ideaCreation" in input) throw new Error();
