...
import { enrollmentSchema, startSchema } from "./contracts";
import { verifyNativeTaskApprovalBinding } from "./task-approval-binding";
import { nativeRecoveryPermissionSchema } from "./recovery-authority";

const packetSchema = z.object({ schema: z.literal("control-room.native-task-approval-packet/v1"),
  approval: ownerApprovalAttestationSchema, recovery: nativeRecoveryPermissionSchema }).strict();
export type NativeTaskApprovalPacket = z.infer<typeof packetSchema>;
