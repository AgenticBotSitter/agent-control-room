...
export const localHarnessCapabilitiesV1: readonly LocalHarnessCapabilityV1[] = Object.freeze([
  ...
  Object.freeze({
    ...
    label: "Claude Code",
    state: "setup_required",
    stateLabel: "Local delivery preparation complete; process proof required",
    summary: "Control Room can prepare one bounded Claude text-review delivery, retain its one-time receipt, and recover a protected result for review. It does not yet own a qualified local Claude process.",
    ...
    safeNow: "Save and recheck a bounded text-review delivery, then validate the source-side result and recovery path. This does not contact, start or grant work to Claude Code.",
    sourceOnly: "The task-plan, delivery, result and recovery path is source-only; it is not evidence of an installed Claude Code process or its permissions.",
