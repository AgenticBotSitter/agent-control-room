...
export function ReadyFrontierProjectView(props: { data: ReadyFrontierViewStateV1; projectId: string;
  ...
  return <section id="ready-frontier" className="detail-card section-block frontier-workspace">
    <div className="section-heading"><div><p className="eyebrow">Authenticated repository cycle</p><h2>Ready frontier</h2></div><span className="simulation-only">Policy-gated · no action controls</span></div>
