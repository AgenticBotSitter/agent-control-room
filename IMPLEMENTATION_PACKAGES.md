...
| --- | --- | --- | --- |
| P1 project/results | Markdown renderer, protected result identity checks, task-switch isolation, clear-on-reauthorization, retained drafts, cancelled stale reads, ordinary/Idea archive-reopen and exact-key retry tests; explicit project pages, configuration proof, 360px keyboard/mobile/deep-link coverage, safe Project News and ranked owner attention are now on public main | Separately admitted protected attachments, live worker/capacity facts, human assistive-technology/zoom/contrast acceptance and real-harness browser acceptance | Compiled product-browser acceptance includes 184 accessibility checks; physical assistive-technology and live-harness acceptance remain open |
