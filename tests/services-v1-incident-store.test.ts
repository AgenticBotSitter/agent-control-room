...
const open = { tenantId: "tenant:incident", serviceId: "service.worker", correlationKey: "service:service.worker:service_not_running", action: "open_or_update" as const, severity: "critical" as const, safeReasonCode: "service_not_running", observedAt: "2026-08-27T00:00:00.000Z" };
