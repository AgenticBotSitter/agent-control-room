...
test("four-source reader propagates navigation cancellation to every transport", async () => {
  let attached = 0;
...
test("project view presents eligibility, availability, connections, and work as separate evidence", () => {
  ...
  assert.doesNotMatch(html, /Assign without starting|Start work|Reserve worker/);
});
