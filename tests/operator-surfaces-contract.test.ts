...
test("CR6E read projections are deterministic, keep failed delivery visible, and cannot elevate Owner Focus", () => {
  ...
  const snapshot = buildOperatorSurfaceSnapshotV1({ contractVersion: OPERATOR_SURFACES_CONTRACT_V1, tenantId: "tenant:1", generatedAt: now, fleet: [], bottlenecks: [], serviceIncidents: [], actionInbox: [openSoon, item], ownerFocus: [] });
