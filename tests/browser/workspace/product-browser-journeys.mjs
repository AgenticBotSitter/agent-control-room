  ...
  return Object.freeze({
    ...
    journeys: Object.freeze([
      ...
      Object.freeze({ title: "Prepare a revised task and follow its protected follow-up page",
        ...
        proof: "After Request changes, the Prepare revised task UI surfaces a revisions endpoint whose follow-up page opens with a fresh task id and survives reload; this exercise requires the bootstrap runtime wired with revisionPlanning, so the journey is documented here as a coordinated package and run via the private-revision-browser-acceptance harness rather than as inline evidence in this script's single-process scope.",
        simulated: true }),
      ...
      Object.freeze({ title: "Exercise keyboard focus at both 360px and 1280px without sideways scroll",
        command: "(no protected command)",
        proof: "The narrow product page begins with the skip link (a.skip-link, \"Skip to content\"); the wide product page begins with a workspace action link to /tasks, then surfaces the alpha task link in the tab order. Both reaches are exercised at 360px and 1280px without sideways scroll.",
        simulated: true }),
